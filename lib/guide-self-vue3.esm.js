...
function patchProp(el, key, value) {
    ...
    if (isNativeEvent(key)) {
        ...
        // 此处的 props[key]（value） 为 callback，为防止混淆故未在上方进行 props[key] 对提前解析
...
export { createApp, createAppAPI, createElement, createRenderer, createTextVNode, getCurrentInstance, h, inject, insert, patchProp, provide, renderSlots };
